...
class MixedDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, ds_list, mode, dataset_mix_pdf, dataset_root_path='', **kwargs):
        ...
        for ds in self.dataset_list:
            if ds in ['rich', 'prox']:
                self.datasets.append(BaseDataset(ds, mode, model_type='smplx', dataset_root_path=dataset_root_path, **kwargs))
            elif ds in ['damon']:
                self.datasets.append(BaseDataset(ds, mode, model_type='smpl', dataset_root_path=dataset_root_path, **kwargs))
            else:
